...
function TeamSection() {
    return (
        ...
        <section class="i pg ji gp uq">
            ...
            <img src={shape08} alt="Shape Bg" class="h q r" />
            <img src={shape09} alt="Shape" class="of h y z/2" />
            <img src={shape10} alt="Shape" class="h _ aa" />
            <img src={shape11} alt="Shape" class="of h m ba" />
                ...
                <div class="wc qf pn xo gg cp">
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src={team01} alt="Team" />
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src={team02} alt="Team" />
                            <div class="ef im nl il">
                                <span class="h -ud-left-5 -ud-bottom-21 rc de gd gh if wa"></span>
                                <span class="h s p rc vd hd mh va"></span>
                                <div class="h s p vd ij jj xa">
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src={team03} alt="Team" />
                            <div class="ef im nl il">
                                <span class="h -ud-left-5 -ud-bottom-21 rc de gd gh if wa"></span>
                                <span class="h s p rc vd hd mh va"></span>
                                <div class="h s p vd ij jj xa">
