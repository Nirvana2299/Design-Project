                ...
                <div className="wc qf pn xo gg cp">
                    ...
                    <div className="animate_top rj">
                        <div className="c i pg z-1">
                            <img className="vd" src={team01} alt="Team" />
                            <div className="ef im nl il">
                                ...
                                <div className="h s p vd ij jj xa">
                                    <ul className="tc xf wf gg">
                                        <li>
                                            <a href="#">
                                                <svg className="uh vl ml il" width="10" height="18" viewBox="0 0 10 18"
                                        ...
                                        <li>
                                            <a href="#">
                                                <svg className="uh vl ml il" width="18" height="14" viewBox="0 0 18 14"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <li>
                                            <a href="#">
                                                <svg className="uh vl ml il" width="17" height="16" viewBox="0 0 17 16"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div className="animate_top rj">
                        <div className="c i pg z-1">
                            <img className="vd" src={team02} alt="Team" />
                            <div className="ef im nl il">
                                <span className="h -ud-left-5 -ud-bottom-21 rc de gd gh if wa"></span>
                                <span className="h s p rc vd hd mh va"></span>
                                <div className="h s p vd ij jj xa">
                    ...
                    <div className="animate_top rj">
                        <div className="c i pg z-1">
                            <img className="vd" src={team03} alt="Team" />
                            <div className="ef im nl il">
                                <span className="h -ud-left-5 -ud-bottom-21 rc de gd gh if wa"></span>
                                <span className="h s p rc vd hd mh va"></span>
                                <div className="h s p vd ij jj xa">
