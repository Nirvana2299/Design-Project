                        ...
                        <div className="tc _o">
                            <div className="animate_left jn/2">
                                ...
                                <div className="tc tf yo zf mb">
                                    <motion.a animate={{ scale: 1 }} initial={{ scale: 0 }} transition={{ duration: 0.4, delay: 0.35 }} href="#" className="ek jk lk gh gi hi rg ml il vc _d _l">Get Started Now</motion.a>
