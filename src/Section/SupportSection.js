        ...
        <section id="support" class="i pg fh rm ji gp uq">
            ...
            <div>
                <div class="animate_top bb ze rj ki xn vq">
                    <h2 class="fk vj pr kk wm on/5 gq/2 bb _b">Let’s Stay Connected</h2>
                    <p class="bb on/5 wo/5 hq">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using.</p>
                </div>
            </div>
            ...
            <div class="i va bb ye ki xn wq jb mo">
                <div class="tc uf sn tf rn un zf xl:gap-10">
                    <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                        ...
                        <img src={shape03} alt="Shape" class="h la x wd" />
                        <img src={shape06} alt="Shape" class="h la ma ne kf" />
                        <div class="fb">
            ...
            <section class="i pg gh ji">
                ...
                <img class="h p q" src={shape16} alt="Bg Shape" />
